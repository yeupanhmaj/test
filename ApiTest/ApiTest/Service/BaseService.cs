...
namespace ApiTest.Service
{
    public abstract class BaseService<T> where T : new()
    {
        ...
        /*  protected void ApplyReportField(ParameterFields fields, string reportFieldName, object value)
          {
              ParameterField paramField = null;
              ParameterDiscreteValue parameterVal = null;
              paramField = fields[reportFieldName];
              if (paramField != null)
              {
                  parameterVal = new ParameterDiscreteValue();
                  parameterVal.Value = value;
                  paramField.CurrentValues.Add(parameterVal);
              }
          }*/
